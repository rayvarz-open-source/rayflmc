...
export default class SelectBoxForm extends FormController {
  ...
  elements = [
    ...
    Container([
      ...
      .flex([1, 1, 1, 1]),
    Container([
      SelectBox(this.valueVariants, 1)
        .variant(this.variant)
        .colors(SelectBoxColors.Default),
      SelectBox(this.valueVariants, 2)
        .variant(this.variant)
        .colors(SelectBoxColors.Secondary),
      SelectBox(this.valueVariants, 3)
        .variant(this.variant)
        .colors(SelectBoxColors.Primary),
      SelectBox(this.valueVariants, 3)
        .variant(this.variant)
        .disabled(true)
    ])
