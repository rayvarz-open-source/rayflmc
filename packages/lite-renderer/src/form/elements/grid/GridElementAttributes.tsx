 ...
 */
export type ActionDefinitions<T extends object> = (
  | Action<T>
  | ((rowData: T) => Action<T>))[];
/**
...
export type Datasource<T extends object> =
  | T[]
  | ((query: Query<T>) => Promise<QueryResult<T>>);
/**
 * @[{"bidirectional":false,"required":false,"default":"{}"}]
 */
 ...
 */
export type OnSelectedChange<T> =
  | ((data: T[], rowData?: T) => void)
  | undefined;
/**
...
export const TypeGuards = {
  isColumnDefinitions: (value: any): value is ColumnDefinitions<any> =>
    Array.isArray(value),
  isActionDefinitions: (value: any): value is ActionDefinitions<any> =>
    Array.isArray(value),
  isDatasource: (value: any): value is Datasource<any> =>
  ...
  isOnRowClick: (value: any): value is OnRowClick<any> =>
    typeof value === "function" || typeof value === "undefined"
};
