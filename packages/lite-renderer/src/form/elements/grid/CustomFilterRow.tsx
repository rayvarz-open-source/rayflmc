...
class CustomTableFilterRow extends React.Component<Props> {
  ...
  renderDefaultFilter = (columnDef) => {
    const localization = { ...CustomTableFilterRow.defaultProps.localization, ...this.props.localization };
    return (
      <TextField
  ...
  getComponentForColumn(columnDef) {
    ...
    if (columnDef.field || columnDef.customFilterAndSearch) {
      ...
      } else if (columnDef.filterType === 'range') {
        return <Input
...
CustomTableFilterRow.defaultProps = {
  emptyCell: false,
  columns: [],
  selection: false,
  hasActions: false,
